$(document).ready(function () {
	$(".awesome__slider").slick({
		...
		lazyLoad: "ondemand",
		prevArrow:
			'<button class="prev-img"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9e327b" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"/></svg></button>',
		nextArrow:
			'<button class="next-img"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#9e327b" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right next-img"><polyline points="9 18 15 12 9 6"/></svg></button>'
	});
