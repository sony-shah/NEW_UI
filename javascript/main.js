...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
            $('.logo-header').find('img').attr( {src:'./images/home/VIPL.png'} );
            $('.logo-footer-style2').find('img').attr( {src:'./images/home/VIPL.png'} );
            $('.logo-footer').find('img').attr( {src:'./images/home/VIPL.png'} );
